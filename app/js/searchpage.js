...
define(['unity/keyDownEvent','i18n!nls/language','unity/commonFun'],function(keyDownEvent,language,commonFun) {
    'use strict';
    //-- 首页填充数据
    function fillData() {
    ...
    function focusInit(){
        ...
        var searchData = search_input.value;
        search_input.value = searchData;
        search_input.focus();
                ...
                if(search_data){
                    ...
                    if(commonFun.isURL(search_data)){
                        if(!(/(https|http|ftp|rtsp|mms):\/\//.test(search_data))){
                            search_data = 'https://' + search_data ;
                        }
                        url = search_data
                    }else{
                        // url = "https://www.google.com/search?sourceid=chrome&ie=UTF-8&q="+search_data;
                        url = "https://www.syclone.us/search/pcode336gvd/?search_term=" + search_data
                    }
                    search_input.blur();
    ...
    function onkeydownEvent (){
        ...
        keyDown.bindKey('s_search',new searchFocusEvent())
        keyDown.bindKey('s_history',new historyFocusEvent())
    }
