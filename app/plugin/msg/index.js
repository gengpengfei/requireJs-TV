...
define(['css!./index.css'],function() {
  ...
  (function (window, document) {
    ...
    Msg.prototype._creatElement = function() {
      ...
      var footerHTML =
        '<div class="msg-footer"><div class="msg-footer-btn msg-active" id="m_1"><img src="image/common/cancel.webp"/><img class="cancel-button btn-active" src="image/common/cancel-active.webp"/></div><div class="msg-footer-btn" id="m_2" ><img src="image/common/confirm.webp"/><img class="confirm-button btn-active" src="image/common/confirm-active.webp"/></div></div>';
      //拼接完整html
    ...
    Msg.prototype._bind = function(el,overlay) {
      ...
      var keydownEvent = function(e){
        ...
        if (e.keyCode == 147 || e.keyCode == 219 || e.keyCode == 27) {
          cancle();
        }
      }
      el.querySelector(".cancel-button").addEventListener("click", cancle);
      el.querySelector(".confirm-button").addEventListener("click", confirm);
