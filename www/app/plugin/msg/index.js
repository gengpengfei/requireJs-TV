...
define(['css!./index.css'],function() {
  ...
  (function (window, document) {
    ...
    Msg.prototype._creatElement = function() {
      ...
      var footerHTML =
        '<div class="msg-footer"><div class="msg-footer-btn msg-active" id="m_1"><img class="cancel-button" src="app/image/common/delete.webp"/></div><div class="msg-footer-btn" id="m_2" ><img class="confirm-button" src="app/image/common/save.webp"/></div></div>';
      //拼接完整html
